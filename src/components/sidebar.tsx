    ...
    <div>
      ...
      >
        <div className="relative w-24 h-24">
          ...
          <div className="absolute inset-0 bg-neutral-600 hover:bg-neutral-500 m-1 text-white font-bold flex items-center justify-center transform -translate-y-1 transition-transform active:translate-y-0 [clip-path:polygon(0_0,75%_0,100%_50%,75%_100%,0_100%)]" />
        </div>
      </button>
      ...
      <aside className={`fixed top-0 left-0 h-full w-64 text-white transform transition-transform duration-300 ease-in-out z-40 ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"} md:block`}>
        ...
        <nav className="flex flex-col text-center justify-center">
          ...
          <div className="relative w-full">
            <div className="absolute inset-0 bg-neutral-700 shadow-[0_4px_0_rgba(0,0,0,0.5)] [clip-path:polygon(0_20%,100%_0,90%_90%,0_100%)]" />
            <Link href="/" rel="noopener noreferrer" className="block bg-neutral-600 hover:bg-neutral-500 mr-1 mt-1 mb-1 py-8 px-4 font-orbitron font-bold text-xl transform -translate-y-1 transition-transform active:translate-y-0 [clip-path:polygon(0_20%,100%_0,90%_90%,0_100%)]">Project Dex</Link>
          </div>
        </nav>
      </aside>
